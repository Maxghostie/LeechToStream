...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1492824147:AAHJjugUae2eXQLIZuq4N9hVfkkw6qSs6jY")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 948659))
    API_HASH = os.environ.get("fbc5894ad4154499f90bba0421b43359")
    OWNER_ID = int(os.environ.get("OWNER_ID", 1123693059))
    # Get these values from my.telegram.org
    # to store the channel ID who are authorized to use the bot
    AUTH_CHANNEL = set(int(x) for x in os.environ.get("AUTH_CHANNEL", "-1001335498211").split())
    ...
    CUSTOM_FILE_NAME = os.environ.get("CUSTOM_FILE_NAME", "[WizTX]")
